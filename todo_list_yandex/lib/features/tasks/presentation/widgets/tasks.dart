...
class TasksState extends ConsumerState<Tasks> {
  ...
  Widget build(BuildContext context) {
    ...
    return tasksAsyncValue.when(
                  ...
                  return Dismissible(
                    ...
                    background: Stack(
                      children: [
                        Container(
                          color:
                              task.done ? colors.onSecondary : colors.secondary,
                        ),
                        Align(
                    ...
                    onDismissed: (direction) async {
                      ...
                      if (direction == DismissDirection.startToEnd) {
                        ...
                        TaskLogger().logDebug('${box.values}');
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                        ...
                        TaskLogger().logDebug('Задача ${task.text} удалена');
                      }
                    },
      ...
      error: (error, stack) =>
          const Center(child: Text('Ошибка загрузки задач')),
    );
  }
}
